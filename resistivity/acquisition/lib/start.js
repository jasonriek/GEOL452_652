...
function exportCSV() {
    try {
        if (enableData()) {
            ...
            let nValues = 0;
            let water = new Array(nValues);
            let basement = new Array(nValues);
            getModel();
            res1 = new ResistivityModel(mx, my, type, trend, smin, nperd, ndec, ndata, water, basement, nValues);
            ...
            let file_name = "ResistivityData.csv";
