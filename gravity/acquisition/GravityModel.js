...
//return to base every _ minutes
    ...
    { //parameters being read in from saveFormasText function
        ...
        { 
            ...
            */
            ...
            // Set parameters of shaft (PCB: moved to 120 and ctop from 4 to 7)
            cxloc = 120.0;
            cyloc = -10.0;
            cradius = 5.0;
            cdrho = -1.67;
   ...
   //     } while (rad >= 1 || rad === 0);
    ...
    //    return (x2 * c);
    //}  Below is new random thing.. 9/25 at 3:10pm
//function gaussianRand() {
//			let ran1= 0.7 * Math.random()-0.5;
//			return ran1    }   
        function gaussianRand() {
			let ran1 = Math.random() + Math.random() + Math.random();
			let ran2 = Math.random() + Math.random() + Math.random();
			let ran3 = Math.random() + Math.random() + Math.random();
			let ran4 = Math.random() + Math.random() + Math.random();
			let ransum = 0.5*(ran1+ran2+ran3+ran4-6.0)
			return ransum           
    }   
